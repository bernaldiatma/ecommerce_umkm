...
import 'package:ecommerce_umkm/customer/screens/order_screen/components/order_detail_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (_) => OrderDetialscreen(order: order)),
        );
      },
      child: Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              '${product.quantity.toString()} barang',
