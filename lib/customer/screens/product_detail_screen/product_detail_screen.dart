...
import 'package:ecommerce_umkm/customer/screens/store_screen/store_screen.dart';
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          onTap: () {
                            final bool isFavorite = favoriteProvider.isExist(
                              widget.product,
                            );
                    ...
                    child: Container(
                      child: GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (_) => StoreScreen(storeName: widget.product.storeName))
                          );
                        },
                        child: Row(
                          children: [
