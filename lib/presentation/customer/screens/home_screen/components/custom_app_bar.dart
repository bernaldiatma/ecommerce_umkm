...
import 'package:ecommerce_umkm/presentation/widget/old_custom_search_bar.dart';
import 'package:get_storage/get_storage.dart';
import 'package:ecommerce_umkm/presentation/widget/app_bar_action_button.dart';
        ...
        child: Column(
          children: [
            Row(
              ...
              children: [
                Consumer<UserProvider>(builder: (_, user, _) {
                  var text = '';
                  if (user.loading) {
                    text = '______';
                  } else {
