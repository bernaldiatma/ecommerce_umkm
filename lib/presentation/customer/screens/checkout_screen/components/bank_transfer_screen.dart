...
import 'package:ecommerce_umkm/presentation/customer/screens/checkout_screen/components/bank_payment_success.dart';
...
class BankTransferScreen extends StatefulWidget {
  ...
  const BankTransferScreen({Key? key, required this.paymentMethod, required this.expedition})
    : super(key: key);
