...
import 'package:ecommerce_umkm/presentation/seller/screens/seller_order_list_screen/components/seller_order_detail_screen.dart';
...
class SellerOrderCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final firstProduct = order.orderDetail.isNotEmpty
                ...
                Row(
                  children: [
                    ClipRRect(
                      borderRadius: BorderRadius.circular(12),
                      child: Image.network(
                        '$BASE_URL${firstProduct!.product.productPhotoPath}',
                        width: 50,
                        height: 50,
                        fit: BoxFit.cover,
                      ...
                      child: SizedBox(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              '${order.qty.toStringAsFixed(0)} barang',
